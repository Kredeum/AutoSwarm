...
<div id="details">
	...
	<p>
		Swarm - Image Path
		<span>{@html displayBzzURI(beeMetadata.beeHash, nftMetadata.nftImageName)}</span>
	</p>
	<hr />
	<p>
	...
	<p>
		TBA - Image URL
		<span> {@html displayBzzURL(tbaMetadata.tbaSwarmHash, nftMetadata.nftImageName)}</span>
	</p>
	<p>
