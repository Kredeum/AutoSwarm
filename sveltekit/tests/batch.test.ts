...
// 	expect(batchNBalToBzz(0n, BUCKET_DEPTH + 1)).toBe(0n);
// 	expect(batchNBalToBzz(250n, BUCKET_DEPTH + 2)).toBe(1_000n);
// 	expect(batchNBalToBzz(25n * 10n ** 9n, BUCKET_DEPTH + 4)).toBe(1_000n * 10n ** 9n);

// 	expect(batchNBalToBzz(390625n, BUCKET_DEPTH + 2)).toBe(10n ** 12n);
// 	expect(batchNBalToBzz(244140625n, BUCKET_DEPTH + 4)).toBe(10n ** 16n);
// });
