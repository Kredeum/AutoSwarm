<script lang="ts">
	...
	import { sendMarketAttachStamps, sendMarketSync } from '@autoswarm/common/src/send/sendMarket';
	...
	import { callMarketCurrentBatchId } from '@autoswarm/common/src/call/callMarket';
	...
	import { callTbaToken } from '@autoswarm/common/src/call/callTba';
