...
import type { NftMetadata, Metadata } from "../constants/types";
...
const callNftMetadata = async (nftChainId: number, nftCollection: Address, nftTokenId: bigint): Promise<[Metadata, NftMetadata]> => {
